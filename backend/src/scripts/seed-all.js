    ...
    try {
        ...
        await CauHinhPhongKham.create({
            ...
            chinh_sach_hoan_tien: [
                ...
                {
                    thoi_gian_toi_thieu_gio: 2,
                    ti_le_hoan: 50,
                    phi_huy_co_dinh: 20000,
                },
            ],
            cau_hinh_nhac_lich: {
                bat_cho_nhac: true,
        ...
        await CaiDatThanhToan.create([
            {
                ten_cai_dat: "hoan_tien_truoc_24h",
                gia_tri: "100",
                mo_ta: "Hoàn 100% nếu hủy trước 24 giờ.",
            },
            {
                ten_cai_dat: "hoan_tien_truoc_2h",
                gia_tri: "50",
                mo_ta: "Hoàn 50% nếu hủy trước 2 giờ.",
            },
            {
                ten_cai_dat: "khong_hoan_tien_sau_2h",
                gia_tri: "0",
                mo_ta: "Không hoàn tiền nếu hủy quá sát giờ khám.",
            },
            {
                ten_cai_dat: "hoan_tien_admin_huy",
                gia_tri: "100",
                mo_ta: "Admin hủy lịch được hoàn 100%.",
            },
        ]);
        ...
        const services = await DichVu.create(
            [
                ...
                },
                {
                    ...
                    gia: 250000,
                    mo_ta_ngan:
                        "Kỹ thuật nội soi ống mềm thế hệ mới, không châm chít, không đau nhói.",
                    ...
                    chuan_bi_truoc:
                        "Nhịn ăn 2 giờ trước khi nội soi nếu có tiền sử nhạy cảm vùng họng.",
                ...
                },
                {
                    ...
                    gia: 280000,
                    mo_ta_ngan:
                        "Gói kiểm tra toàn diện tai mũi họng dành riêng cho trẻ em.",
                    ...
                    chuan_bi_truoc:
                        "Cho trẻ nghỉ ngơi đầy đủ và ăn nhẹ trước khi đến khám.",
                    specialty_id: specialties[0]._id,
                    la_goi: true,
                ...
                },
                {
                    ...
                    gia: 320000,
                    mo_ta_ngan:
                        "Đánh giá nốt xơ dây thanh và phục hồi giọng nói.",
                    mo_ta: "Dành cho giáo viên, ca sĩ, MC hoặc người sử dụng giọng nói cường độ cao liên tục.",
                    hinh_anh:
                        "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&auto=format&fit=crop&q=80",
                    chuan_bi_truoc:
                        "Hạn chế dùng nước đá lạnh và tránh gằn giọng trước khi khám.",
                    specialty_id: specialties[0]._id,
                    la_goi: true,
                ...
                },
                {
                    ...
                    gia: 450000,
                    mo_ta_ngan:
                        "Gói tầm soát TMH toàn diện dành cho giai đoạn giao mùa.",
                    ...
                    chuan_bi_truoc:
                        "Tránh dùng thuốc chống dị ứng antihistamine 24h trước xét nghiệm.",
        ...
        const doctors = await BacSi.create([
            ...
            },
            {
                ...
                chi_nhanh_id: clinic._id,
                tieu_su:
                    "Bác sĩ nhi khoa chuyên theo dõi trẻ nhỏ và trẻ sơ sinh.",
            ...
            },
            {
                ...
                chi_nhanh_id: clinic._id,
                tieu_su:
                    "Bác sĩ Tai Mũi Họng kết hợp theo dõi dịch vụ tại nhà.",
        ...
        await HoSoChiTietBacSi.create([
            {
                ...
                chuc_danh: "BSCKI",
                chuc_vu: "Bác sĩ Chuyên khoa Nội",
                chuc_vu_hien_tai: "Bác sĩ Trưởng khoa Nội tổng hợp - Hệ thống Y tế VitaFamily",
                ma_cchn: "CCHN-008921/BYT",
                gioi_thieu_ngan: "Bác sĩ có 9 năm kinh nghiệm chuyên sâu trong chẩn đoán và điều trị bệnh lý nội khoa, tim mạch và rối loạn chuyển hóa.",
                bang_cap_hoc_vi_tags: ["Bác sĩ Chuyên khoa I", "Bác sĩ Đa khoa"],
                ngon_ngu: ["Tiếng Việt", "Tiếng Anh (IELTS Y khoa 7.5)"],
                the_manh_chuyen_mon: [
                    "Khám & quản lý bệnh lý tim mạch, huyết áp",
                    "Tư vấn phác đồ điều trị tiểu đường & chuyển hóa",
                    "Nội soi chẩn đoán tiêu hóa lâm sàng"
                ],
                benh_ly_dieu_tri: [
                ...
                qua_trinh_cong_tac: [
                    {
                        noi_cong_tac: "Bệnh viện Đa khoa Tuyến Tỉnh A",
                        chuc_vu: "Bác sĩ Điều trị Nội khoa",
                        tu_nam: 2017,
                        den_nam: 2021,
                    },
                    {
                        noi_cong_tac: "Hệ thống Y tế VitaFamily",
                        chuc_vu: "Bác sĩ Trưởng khoa Nội",
                        tu_nam: 2021,
                        den_nam: null,
                    },
                ],
                qua_trinh_dao_tao: [
                    ...
                    {
                        ten_bang: "Bác sĩ Chuyên khoa I Nội khoa",
                        truong: "Đại học Y Hà Nội",
                        tu_nam: 2018,
                        den_nam: 2020,
                    },
                ],
                thanh_vien_hoi: ["Hội Nội khoa Việt Nam", "Hội Tim mạch học Việt Nam"],
                giai_thuong: [{ ten: "Bác sĩ Tận tâm vì sức khỏe cộng đồng", nam: 2022 }],
            },
            {
                doctor_id: doctors[1]._id,
                chuc_danh: "ThS.BS",
                chuc_vu: "Bác sĩ Nhi khoa",
                chuc_vu_hien_tai: "Phó Trưởng khoa Nhi - Hệ thống Y tế VitaFamily",
                ma_cchn: "CCHN-009102/BYT",
                gioi_thieu_ngan: "Bác sĩ có 9 năm kinh nghiệm chuyên ngành Nhi khoa, chuyên sâu về hô hấp, dinh dưỡng và phát triển trẻ nhỏ.",
                bang_cap_hoc_vi_tags: ["Thạc sĩ Y học", "Bác sĩ Nhi khoa"],
                ngon_ngu: ["Tiếng Việt", "Tiếng Anh"],
                the_manh_chuyen_mon: [
                    "Khám và điều trị hô hấp trẻ em",
                    "Tư vấn dinh dưỡng & phát triển thể chất",
                    "Tầm soát bệnh lý bẩm sinh & dị ứng"
                ],
                benh_ly_dieu_tri: [
                    "Sốt siêu vi & Viêm đường hô hấp",
                    "Hen phế quản trẻ em",
                    "Viêm tai giữa & Viêm phế quản"
                ],
                qua_trinh_cong_tac: [
                    {
                        noi_cong_tac: "Bệnh viện Nhi Đồng",
                        chuc_vu: "Bác sĩ Nội trú Nhi",
                        tu_nam: 2017,
                        den_nam: 2021,
                    },
                    {
                ...
                giai_thuong: [{ ten: "Bác sĩ Nhi được yêu thích nhất", nam: 2023 }],
            },
            {
                doctor_id: doctors[2]._id,
                chuc_danh: "BSCKI",
                chuc_vu: "Bác sĩ Tai Mũi Họng",
                chuc_vu_hien_tai: "Bác sĩ Chuyên khoa Tai Mũi Họng - Hệ thống Y tế VitaFamily",
                ma_cchn: "CCHN-007834/BYT",
                gioi_thieu_ngan: "Bác sĩ có hơn 9 năm kinh nghiệm chuyên sâu khám Tai Mũi Họng, nội soi ống mềm không đau và phẫu thuật vi phẫu.",
                bang_cap_hoc_vi_tags: ["Bác sĩ Chuyên khoa I", "Bác sĩ Đa khoa"],
                ngon_ngu: ["Tiếng Việt", "Tiếng Anh (IELTS 7.0)"],
                the_manh_chuyen_mon: [
                    "Nội soi Tai Mũi Họng ống mềm thế hệ mới",
                    "Điều trị triệt để viêm xoang & polyp mũi",
                    "Phục hồi thanh quản & giọng nói chuyên sâu"
                ],
                benh_ly_dieu_tri: [
                    "Viêm mũi xoang cấp & mạn tính",
                    "Viêm Amidan & Viêm V.A",
                    "Khàn tiếng & Hạt xơ dây thanh",
                    "Ù tai & Viêm tai giữa"
                ],
                qua_trinh_cong_tac: [
                    {
                        noi_cong_tac: "Trung tâm Tai Mũi Họng Tuyến Tỉnh",
                        chuc_vu: "Bác sĩ TMH",
                        tu_nam: 2017,
                        den_nam: 2021,
                    },
                ...
                qua_trinh_dao_tao: [
                    {
                        ten_bang: "Bác sĩ Đa khoa",
                        truong: "Đại học Y Dược Huế",
                        tu_nam: 2011,
                        den_nam: 2017,
                    },
                    {
                        ten_bang: "Chuyên khoa I Tai Mũi Họng",
                        truong: "Đại học Y Dược Huế",
                        tu_nam: 2018,
                        den_nam: 2020,
                    },
                ...
                giai_thuong: [{ ten: "Chuyên gia Tai Mũi Họng Tiêu biểu", nam: 2021 }],
            },
        ]);
        ...
        const schedules = await LichLamViec.create([
            ...
            },
            {
                ...
                trang_thai_ngay: "lam_viec",
                ghi_chu_ngay:
                    "Ca chiều nội khoa và theo dõi xét nghiệm tại nhà.",
                slots: [
                    {
                        gio_bat_dau: "13:30",
                        gio_ket_thuc: "14:00",
        ...
        const appointments = await LichHen.create([
            {
                ...
                gio_den_thuc_te: new Date(
                    twoDaysAgo.getTime() + 7.5 * 60 * 60 * 1000,
                ),
        ...
        const examResults = await KetQuaKham.create([
            {
                ...
                chan_doan: "Rối loạn tiền đình nhẹ",
                huong_dan_dieu_tri:
                    "Uống thuốc đúng giờ, ngủ đủ giấc và tái khám nếu chóng mặt kéo dài.",
                ghi_chu: "Không ghi nhận dấu hiệu thần kinh khu trú.",
                ngay_tai_kham: addDays(today, 7),
                co_the_sua: false,
                dich_vu_phat_sinh: [
                    {
                        ten: "Đo huyết áp tư thế",
                        so_luong: 1,
                        don_gia: 50000,
                        thanh_tien: 50000,
                    },
                ...
                lich_su_sua: [
                    {
                        nguoi_sua_id: doctorUserA._id,
                        noi_dung: "Hoàn tất chẩn đoán ban đầu.",
                    },
                ],
            },
            {
                ...
                chan_doan: "Viêm mũi họng cấp",
                huong_dan_dieu_tri:
                    "Giữ ấm, súc họng nước muối và tái khám nếu sốt cao.",
                ...
                lich_su_sua: [
                    {
                        nguoi_sua_id: doctorUserC._id,
                        noi_dung: "Bổ sung hình ảnh nội soi.",
                    },
                ],
            },
            {
                ...
                huong_dan_dieu_tri:
                    "Chờ kết quả xét nghiệm và phản hồi của bác sĩ.",
        ...
        await KetQuaKhamTai.create([
            {
                ...
                hinh_anh_noi_soi: [
                    {
                        url: "https://example.com/tai-1.jpg",
                        mo_ta: "Màng nhĩ phải",
                    },
                    {
                        url: "https://example.com/tai-2.jpg",
                        mo_ta: "Màng nhĩ trái",
                    },
                ],
            },
            {
                ...
                hinh_anh_noi_soi: [
                    {
                        url: "https://example.com/tai-guest.jpg",
                        mo_ta: "Tai ngoài",
                    },
                ],
            },
        ...
        await KetQuaKhamMui.create([
            {
                ...
                hinh_anh_noi_soi: [
                    {
                        url: "https://example.com/mui-1.jpg",
                        mo_ta: "Niêm mạc mũi phù nề nhẹ",
                    },
                ],
            },
            {
                ...
                hinh_anh_noi_soi: [
                    {
                        url: "https://example.com/mui-guest.jpg",
                        mo_ta: "Mũi trái",
                    },
                ],
            },
        ...
        await KetQuaKhamHong.create([
            {
                ...
                hinh_anh_noi_soi: [
                    {
                        url: "https://example.com/hong-1.jpg",
                        mo_ta: "Họng đỏ nhẹ",
                    },
                ],
            },
            {
                ...
                hinh_anh_noi_soi: [
                    {
                        url: "https://example.com/hong-guest.jpg",
                        mo_ta: "Họng khách vãng lai",
                    },
                ],
            },
        ]);
        ...
        await SinhHieuKham.create([
            {
                ...
                lich_su_cap_nhat: [
                    {
                        nguoi_cap_nhat_id: doctorUserA._id,
                        noi_dung: "Nhập sinh hiệu ban đầu.",
                    },
                ],
            },
            {
                ...
                lich_su_cap_nhat: [
                    {
                        nguoi_cap_nhat_id: doctorUserC._id,
                        noi_dung: "Đã đo lại nhiệt độ do bé sốt nhẹ.",
                    },
                ],
            },
            {
                ...
                lich_su_cap_nhat: [
                    {
                        nguoi_cap_nhat_id: doctorUserA._id,
                        noi_dung: "Sinh hiệu cho lịch home.",
                    },
                ],
            },
        ]);
        ...
        await DanhGia.create([
            ...
            },
            {
                ...
                so_sao: 4,
                noi_dung:
                    "Khám kỹ, có nội soi và giải thích cụ thể cho phụ huynh.",
                status: "visible",
            },
        ]);
        ...
        await ThongBao.create([
            {
                ...
                noi_dung:
                    "Bạn đã hoàn thành lịch khám nội khoa và có đơn thuốc mới.",
                loai: "appointment",
            ...
            },
            {
                ...
                noi_dung:
                    "Lịch khám của bé vẫn đang chờ thanh toán để xác nhận.",
                loai: "payment",
            ...
            },
            {
                ...
                noi_dung:
                    "Lịch lấy mẫu xét nghiệm tại nhà đã ghi nhận cọc thành công.",
                loai: "payment",
        ...
        await ThongBaoHeThong.create([
            ...
            },
            {
                ...
                noi_dung:
                    "Phòng khám vừa bổ sung một số gói dịch vụ theo chuyên khoa.",
                url: "/dich-vu",
                doi_tuong: "benh_nhan",
                tao_boi: admin._id,
                ngay_gui: new Date(),
            ...
            },
            {
                ...
                noi_dung:
                    "Lễ tân và điều dưỡng lưu ý kiểm tra lịch đặt hộ trong ca trực hôm nay.",
                url: null,
                doi_tuong: "tat_ca",
                tao_boi: admin._id,
                ngay_gui: new Date(),
        ...
        await TinNhanChat.create([
            ...
            },
            {
                ...
                vai_tro: "ai",
                noi_dung:
                    "Bạn có thể xem lịch tái khám trong hồ sơ lịch hẹn hoặc hỏi trực tiếp lễ tân.",
                thoi_diem: new Date(),
            },
            {
            ...
            },
            {
                ...
                vai_tro: "ai",
                noi_dung:
                    "Bạn có thể đặt hộ cho thành viên gia đình nếu tài khoản đã có hồ sơ thành viên.",
                thoi_diem: new Date(),
            },
        ]);
        ...
        await Counter.bulkWrite([
            ...
            },
            {
                updateOne: {
                    filter: {
                        key: `ma_lich_hen_${isoDateOnly(today).replace(/-/g, "").slice(2)}`,
                    },
                    update: { $set: { seq: 5 } },
                    upsert: true,
                },
            },
            {
                updateOne: {
                    filter: {
                        key: `so_hoa_don_${isoDateOnly(today).replace(/-/g, "").slice(2)}`,
                    },
                    update: { $set: { seq: 4 } },
                    upsert: true,
                },
        ...
        console.log(
            "ℹ️  Các collection singleton/unique như ThongTinPhongKham và CauHinhPhongKham chỉ có 1 document theo đúng ràng buộc schema.",
        );
    } catch (error) {
