...
router.post('/doctors/:id/reviews',     verifyToken, requirePatientRole, booking.createDoctorReview)
router.post('/',                        verifyToken, requirePatientRole, booking.createBooking)
router.patch('/:id/cancel',             verifyToken, requirePatientRole, booking.cancelBooking)
