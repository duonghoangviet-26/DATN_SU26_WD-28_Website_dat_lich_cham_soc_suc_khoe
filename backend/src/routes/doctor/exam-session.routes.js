...
import { amend, get, notifyReception, saveStep, complete } from '../../controllers/doctor/exam-session.controller.js'
...
router.post('/:queueId/notify-reception', notifyReception)
