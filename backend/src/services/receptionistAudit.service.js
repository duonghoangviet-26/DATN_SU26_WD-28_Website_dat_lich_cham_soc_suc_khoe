...
export const HANH_DONG_LE_TAN = {
  ...
  LT_OFFLINE_INTAKE_CENTRAL: 'Tiếp nhận khách vãng lai vào hàng đợi trung tâm',
  LT_OFFLINE_ASSIGN_DOCTOR: 'Điều phối khách vãng lai cho bác sĩ',
  LT_OFFLINE_RETURN_CENTRAL: 'Trả khách vãng lai về hàng đợi trung tâm',
  LT_OFFLINE_CANCEL_CENTRAL: 'Hủy khách vãng lai trong hàng đợi trung tâm',
  LT_SYSTEM_OFFLINE_ASSIGN_SUGGESTED: 'Hệ thống gợi ý điều phối khách vãng lai',
